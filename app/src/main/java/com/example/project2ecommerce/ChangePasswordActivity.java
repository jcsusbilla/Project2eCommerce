...
public class ChangePasswordActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityChangePasswordBinding.inflate(getLayoutInflater());        //reference to xml object, inflate converts xml to java reference
    ...
    static Intent changePasswordIntentFactory(Context context, int userId){
